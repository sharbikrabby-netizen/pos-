...
interface CustomersViewProps {
  customers: Customer[];
  onAddCustomer: (customer: Omit<Customer, "id">) => Promise<void> | void;
...
const CustomersView: React.FC<CustomersViewProps> = ({
  ...
  const handleOpenModal = (customer?: Customer) => {
    if (customer) {
      ...
      setFormData({ name: "", phone: "", email: "", address: "", due_amount: 0 });
          ...
          <form onSubmit={handleSaveCustomer} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, due_amount: parseFloat(e.target.value) || 0 })
                }
                className="w-full px-3 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md"
              />
            </div>
